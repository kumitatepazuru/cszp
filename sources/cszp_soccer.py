...
def setting_jp_loop():
    ...
    if ok != 2:
        ...
        df = data.read()
        data.close()
        inp += " server::auto_mode=true server::kick_off_wait=10 server::game_over_wait=10 server::connect_wait=1500 server::game_log_dir="+df.split(",")[9]+" server::text_log_dir="+df.split(",")[9]
